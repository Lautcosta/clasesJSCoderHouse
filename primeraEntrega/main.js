...
arrayProductos.push(new Producto("Banana", 2500));
arrayProductos.push(new Producto("Manzana", 2000));  
arrayProductos.push(new Producto("Pepino", 3000));
arrayProductos.push(new Producto("Zanahoria", 500));
arrayProductos.push(new Producto("Lechuga", 1800));
...
const ordenarPorPrecio = () => {
  ...
  console.log(`Imprimiendo el array , pero segun su precio de menor a mayor `);
